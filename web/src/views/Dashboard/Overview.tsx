...
export default function Overview() {
    ...
    // Set page title
    useEffect(() => {
        document.title = 'Tableau de bord | LogicAI';
    }, []);
    ...
    return (
        <main className="flex-1 overflow-auto bg-[#010101] rounded-br-xl">
            ...
            <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="rounded-lg bg-white/5 p-4">
                    <div className="flex justify-between items-center">
                        <div className="bg-linear-to-r from-yellow-500 to-amber-500 p-2 rounded-lg">
                                ...
                                <div className="absolute inset-0 flex items-end justify-between px-8 pb-8">
                                    {[0, 20, 40, 60, 80, 100].map((_, index) => (
                                        <div key={index} className="flex-1 flex flex-col items-center gap-2">
                                            <div
                                                className="w-full bg-linear-to-t from-orange-600 to-orange-400 rounded-t-lg transition-all hover:from-orange-500 hover:to-orange-300"
                            ...
                            <tbody>
                                {instances.map((instance) => (
                                    <tr
                                        ...
                                        onClick={() => !actionLoading[instance.uuid] && navigate(`/dashboard/instances/${instance.uuid}`)}
                                    >
